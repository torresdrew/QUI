...
---------------------------------------------------------------------------
-- REFRESH FUNCTIONS (local, registered with Registry)
---------------------------------------------------------------------------
...
if ns.Registry then
    ns.Registry:Register("cdmVisibility", {
        refresh = {
            all = RefreshCDMVisibility,
            cdm = RefreshCDMVisibility,
            cdmMouseover = SetupCDMMouseoverDetector,
            unitframes = UpdateUnitframesVisibility,
            unitframesMouseover = SetupUnitframesMouseoverDetector,
            actionBars = UpdateActionBarsVisibility,
            actionBarsMouseover = SetupActionBarsMouseoverDetector,
            chat = UpdateChatVisibility,
            chatMouseover = SetupChatMouseoverDetector,
        },
        priority = 10,
        group = "cooldowns",
