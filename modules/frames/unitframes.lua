...
local type, pairs, ipairs, pcall, select = type, pairs, ipairs, pcall, select
...
local function RefreshAuras(unitKey)
    if unitKey then
...
_G.QUI_UpdateLockedCastbarToEssential = function(forceUpdate)
    ...
    ns.Registry:Refresh("castbar", "single", "player")
end
