...
local function BuildPrivateAurasSettings(content, gfdb, onChange)
    ...
    CreateComposerCollapsible(content, "Private Auras", function(body, updateH)
        ...
        L:Row(GUI:CreateFormSlider(body, "Text Scale", 0.5, 5, 0.5, "textScale", pa, onChange), SLIDER_HEIGHT, cond)
        L:Row(GUI:CreateFormSlider(body, "Text X Offset", -20, 20, 1, "textOffsetX", pa, onChange), SLIDER_HEIGHT, cond)
        L:Row(GUI:CreateFormSlider(body, "Text Y Offset", -20, 20, 1, "textOffsetY", pa, onChange), SLIDER_HEIGHT, cond)
        L:Finish()
    end, sections, relayout)
