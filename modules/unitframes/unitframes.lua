...
if ns.Registry then
    ...
    -- border (RefreshFrame -> GetSkinBorderColor, no per-frame override), but the
    -- "frames" group isn't refreshed on a skin-color change (which fires only
    -- RefreshAll("skinning")). Re-skin on that too.
