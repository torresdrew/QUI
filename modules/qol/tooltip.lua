...
if not TooltipDebug then
    ...
    function TooltipDebug:Report(resetAfter)
        ...
        AppendCounter(parts, "skin.auraButtonTooltipForbidden", "auraTip")
        AppendCounter(parts, "skin.auraButtonTooltipSkinOk", "auraTipOk")
        AppendCounter(parts, "skin.auraButtonTooltipSkinFail", "auraTipFail")
        AppendCounter(parts, "skin.auraButtonTooltipStableSkip", "auraTipStable")
