...
local function BuildGeneralTab(tabContent, searchContext, selectedSectionKey)
    ...
    if ShouldBuildSection(selectedSectionKey, "combatText") and combatTextDB then
        CreateCollapsible("Combat Status Text Indicator", 1, function(body)
            ...
            sy = P(GUI:CreateFormCheckbox(body, "Enable Combat Text", "enabled", combatTextDB, RefreshCombatText,
                { description = "Show '+Combat' and '-Combat' floating text when combat starts and ends." }), body, sy)
            sy = P(GUI:CreateFormSlider(body, "Display Time (sec)", 0.3, 3.0, 0.1, "displayTime", combatTextDB, RefreshCombatText, nil,
                { description = "How long the combat text stays fully visible before starting to fade, in seconds." }), body, sy)
            sy = P(GUI:CreateFormSlider(body, "Fade Duration (sec)", 0.1, 1.0, 0.05, "fadeTime", combatTextDB, RefreshCombatText, nil,
                { description = "How long the fade-out animation takes after the display time elapses, in seconds." }), body, sy)
            sy = P(GUI:CreateFormSlider(body, "Font Size", 12, 48, 1, "fontSize", combatTextDB, RefreshCombatText, nil,
                { description = "Font size of the combat text." }), body, sy)
            ...
            sy = P(GUI:CreateFormSlider(body, "X Position Offset", -2000, 2000, 1, "xOffset", combatTextDB, RefreshCombatText, nil,
                { description = "Horizontal pixel offset of the combat text from the screen center." }), body, sy)
            sy = P(GUI:CreateFormSlider(body, "Y Position Offset", -2000, 2000, 1, "yOffset", combatTextDB, RefreshCombatText, nil,
                { description = "Vertical pixel offset of the combat text from the screen center." }), body, sy)
            sy = P(GUI:CreateFormColorPicker(body, "+Combat Text Color", "enterCombatColor", combatTextDB, RefreshCombatText, nil,
                { description = "Color of the '+Combat' text shown when entering combat." }), body, sy)
            P(GUI:CreateFormColorPicker(body, "-Combat Text Color", "leaveCombatColor", combatTextDB, RefreshCombatText, nil,
                { description = "Color of the '-Combat' text shown when leaving combat." }), body, sy)
    ...
    if ShouldBuildSection(selectedSectionKey, "automation") and generalDB then
        CreateCollapsible("Automation", 1, function(body)
            ...
            sy = P(GUI:CreateFormCheckbox(body, "Sell Junk Items at Vendors", "sellJunk", generalDB, nil,
                { description = "Automatically sell grey-quality junk items in your bags when you open a merchant window." }), body, sy)
            ...
            sy = P(GUI:CreateFormDropdown(body, "Auto Repair at Vendors", repairOptions, "autoRepair", generalDB, nil,
                { description = "Automatically repair durability when you open a repair merchant. Guild mode tries guild bank funds first and falls back to personal gold." }), body, sy)
            sy = P(GUI:CreateFormCheckbox(body, "Fast Auto Loot", "fastAutoLoot", generalDB, nil,
                { description = "Speed up auto-loot by moving items as fast as the client allows, skipping Blizzard's default per-tick delay." }), body, sy)
            ...
            sy = P(GUI:CreateFormDropdown(body, "Auto Accept Party Invites", inviteOptions, "autoAcceptInvites", generalDB, nil,
                { description = "Automatically accept incoming party/raid invites from the chosen set of senders." }), body, sy)
            sy = P(GUI:CreateFormCheckbox(body, "Auto Accept Role Check", "autoRoleAccept", generalDB, nil,
                { description = "Automatically confirm role checks in LFG using the role you already had selected." }), body, sy)
            sy = P(GUI:CreateFormCheckbox(body, "Auto Accept Quests", "autoAcceptQuest", generalDB, nil,
                { description = "Automatically accept quests from NPCs without requiring a click." }), body, sy)
            sy = P(GUI:CreateFormCheckbox(body, "Auto Turn-In Quests", "autoTurnInQuest", generalDB, nil,
                { description = "Automatically hand in completed quests and pick the only available reward when applicable." }), body, sy)
            sy = P(GUI:CreateFormCheckbox(body, "Auto Select Single Gossip Option", "autoSelectGossip", generalDB, nil,
                { description = "When an NPC gossip has a single option, pick it automatically so you skip the popup." }), body, sy)
            sy = P(GUI:CreateFormCheckbox(body, "Hold Shift to Pause Quest/Gossip Automation", "questHoldShift", generalDB, nil,
                { description = "Hold Shift while interacting to temporarily disable the quest and gossip automations above." }), body, sy)
            sy = P(GUI:CreateFormCheckbox(body, "Auto Insert M+ Keys", "autoInsertKey", generalDB, nil,
                { description = "Automatically place your Mythic+ keystone into the font of power when you open the keystone window." }), body, sy)
            ...
            end, { description = "Turn on combat logging automatically when a Mythic+ run starts, and off when it ends." }), body, sy)
            sy = P(GUI:CreateFormCheckbox(body, "Auto Combat Log in Raids", "autoCombatLogRaid", generalDB, function()
                if _G.QUI_RefreshAutoCombatLogging then _G.QUI_RefreshAutoCombatLogging() end
            end, { description = "Turn on combat logging automatically when you zone into a raid instance." }), body, sy)
            sy = P(GUI:CreateFormCheckbox(body, "Click-to-Teleport on M+ Tab", "mplusTeleportEnabled", generalDB, nil,
                { description = "Allow clicking on a dungeon icon in the Mythic+ UI to cast its teleport spell if you have it." }), body, sy)
            sy = P(GUI:CreateFormCheckbox(body, "Auto-Fill DELETE Confirmation Text", "autoDeleteConfirm", generalDB, nil,
                { description = "Pre-fill the word DELETE into the confirmation box when destroying a rare or higher item." }), body, sy)
            sy = P(GUI:CreateFormCheckbox(body, "Auto-Enable Current Expansion Filter in Auction House", "auctionHouseExpansionFilter", generalDB, nil,
                { description = "Automatically toggle the current expansion filter when you open the Auction House so you only see modern items." }), body, sy)
            P(GUI:CreateFormCheckbox(body, "Auto-Enable Current Expansion Filter in Crafting Orders", "craftingOrderExpansionFilter", generalDB, nil,
                { description = "Automatically toggle the current expansion filter when you open the Crafting Orders window." }), body, sy)
    ...
    if ShouldBuildSection(selectedSectionKey, "popupBlocker") and generalDB then
        ...
        CreateCollapsible("Popup & Toast Blocker", 1, function(body)
            ...
            sy = P(GUI:CreateFormCheckbox(body, "Enable Popup/Toast Blocker", "enabled", popupDB, function()
                ...
                RefreshPopupBlocker()
            end, { description = "Master toggle for the popup and toast blocker. Individual toggles below are only applied when this is on." }), body, sy)

            local popupDescriptions = {
            ...
            local function AddPopupToggle(label, key)
                local check = GUI:CreateFormCheckbox(body, label, key, popupDB, RefreshPopupBlocker,
                    { description = popupDescriptions[key] })
                sy = P(check, body, sy)
            ...
            AddPopupToggle("Block All Microbutton Glows (collections, achievements, etc.)", "blockMicroButtonGlows")
            ...
            local section = body:GetParent()
            section._contentHeight = 30 + 12 * FORM_ROW + 8
        end)
    end
    ...
    if ShouldBuildSection(selectedSectionKey, "quickSalvage") and qsDB then
        CreateCollapsible("Quick Salvage", 3 * FORM_ROW + 8, function(body)
            ...
            end, { description = "Let you mill, prospect, or disenchant items by holding the modifier key below and clicking them in your bags." }), body, sy)
            ...
            sy = P(GUI:CreateFormDropdown(body, "Modifier Key", modifierOptions, "modifier", qsDB, function()
                if _G.QUI_RefreshQuickSalvage then _G.QUI_RefreshQuickSalvage() end
            end, { description = "Modifier combination you must hold while clicking to trigger milling, prospecting, or disenchanting." }), body, sy)
    ...
    if ShouldBuildSection(selectedSectionKey, "consumables") and generalDB then
        CreateCollapsible("Consumable Check", 1, function(body)
            ...
            sy = P(GUI:CreateFormCheckbox(body, "Enable Consumable Check", "consumableCheckEnabled", generalDB, nil,
                { description = "Show a consumables window listing food, flasks, weapon enchants, runes, and healthstones based on the triggers below." }), body, sy)
            ...
            end, { description = "Keep the consumables window visible at all times instead of only showing on trigger events." }), body, sy)
            ...
            local triggerReadyCheck = GUI:CreateFormCheckbox(body, "Ready Check", "consumableOnReadyCheck", generalDB, nil,
            ...
            local triggerDungeon = GUI:CreateFormCheckbox(body, "Dungeon Entrance", "consumableOnDungeon", generalDB, nil,
            ...
            local triggerRaid = GUI:CreateFormCheckbox(body, "Raid Entrance", "consumableOnRaid", generalDB, nil,
            ...
            local triggerResurrect = GUI:CreateFormCheckbox(body, "Instanced Resurrect", "consumableOnResurrect", generalDB, nil,
            ...
            local consumableFoodCheck = GUI:CreateFormCheckbox(body, "Food Buff", "consumableFood", generalDB, nil,
            ...
            local consumableFlaskCheck = GUI:CreateFormCheckbox(body, "Flask Buff", "consumableFlask", generalDB, nil,
            ...
            local consumableOilMHCheck = GUI:CreateFormCheckbox(body, mhLabel .. " (Main Hand)", "consumableOilMH", generalDB, nil,
            ...
            local consumableOilOHCheck = GUI:CreateFormCheckbox(body, ohLabel .. " (Off Hand)", "consumableOilOH", generalDB, nil,
            ...
            local consumableRuneCheck = GUI:CreateFormCheckbox(body, "Augment Rune", "consumableRune", generalDB, nil,
            ...
            local consumableHSCheck = GUI:CreateFormCheckbox(body, "Healthstones", "consumableHealthstone", generalDB, nil,
            ...
            sy = P(GUI:CreateFormCheckbox(body, "Warn When Buffs Expiring", "consumableExpirationWarning", generalDB, nil,
                { description = "Open the consumables window automatically when a tracked buff is close to expiring while you are in instanced content." }), body, sy)
            ...
            sy = P(GUI:CreateFormSlider(body, "Warning Threshold (seconds)", 60, 600, 30, "consumableExpirationThreshold", generalDB, nil, nil,
                { description = "How much time must remain on a tracked buff before the expiration warning fires, in seconds." }), body, sy)
            ...
            sy = P(GUI:CreateFormSlider(body, "Icon Size", 24, 64, 2, "consumableIconSize", generalDB, RefreshConsumables, nil,
                { description = "Pixel size of each consumable icon in the check window." }), body, sy)
            sy = P(GUI:CreateFormSlider(body, "Scale", 0.5, 3, 0.05, "consumableScale", generalDB, RefreshConsumables, nil,
                { description = "Overall scale multiplier applied to the consumables window." }), body, sy)
    ...
    if ShouldBuildSection(selectedSectionKey, "consumableMacros") and cmDB then
        CreateCollapsible("Consumable Macros", 1, function(body)
            ...
            end, { description = "Create per-character macros that pick the best available consumable from your bags. Disabling this removes the macros." }), body, sy)
            ...
            end, { description = "Flask family the QUI_Flask macro should prefer. The macro always picks the highest quality variant in your bags." }), body, sy)
            ...
            sy = P(GUI:CreateFormDropdown(body, "Potion Type", potionOptions, "selectedPotion", cmDB, function()
                if ns.ConsumableMacros then ns.ConsumableMacros:ForceRefresh() end
            end, { description = "Combat utility potion (e.g., stat/tempered potions) used by the QUI_Pot macro." }), body, sy)
            ...
            sy = P(GUI:CreateFormDropdown(body, "Health Potion", healthOptions, "selectedHealth", cmDB, function()
                if ns.ConsumableMacros then ns.ConsumableMacros:ForceRefresh() end
            end, { description = "Healing potion family used by the QUI_Health macro." }), body, sy)
            ...
            sy = P(GUI:CreateFormDropdown(body, "Healthstone", healthstoneOptions, "selectedHealthstone", cmDB, function()
                if ns.ConsumableMacros then ns.ConsumableMacros:ForceRefresh() end
            end, { description = "Healthstone variant used by the QUI_Stone macro." }), body, sy)
            ...
            sy = P(GUI:CreateFormDropdown(body, "Augment Rune", augmentOptions, "selectedAugment", cmDB, function()
                if ns.ConsumableMacros then ns.ConsumableMacros:ForceRefresh() end
            end, { description = "Augment rune family used by the QUI_Rune macro." }), body, sy)
            ...
            sy = P(GUI:CreateFormDropdown(body, "Vantus Rune", vantusOptions, "selectedVantus", cmDB, function()
                if ns.ConsumableMacros then ns.ConsumableMacros:ForceRefresh() end
            end, { description = "Vantus rune the QUI_Vantus macro should use — useful for raid boss attempt buffs." }), body, sy)
            ...
            sy = P(GUI:CreateFormDropdown(body, "Weapon Consumable", weaponOptions, "selectedWeapon", cmDB, function()
                if ns.ConsumableMacros then ns.ConsumableMacros:ForceRefresh() end
            end, { description = "Weapon oil, stone, or enchant consumable used by the QUI_Weapon macro." }), body, sy)

            sy = P(GUI:CreateFormCheckbox(body, "Chat Notifications", "chatNotifications", cmDB, nil,
                { description = "Print a chat message each time the consumable macros are rebuilt so you know which item was chosen." }), body, sy)
    ...
    if ShouldBuildSection(selectedSectionKey, "targetDistance") and rangeCheckDB then
        CreateCollapsible("Target Distance Bracket Display", 1, function(body)
            ...
            end, { description = "Show the current target's distance bracket (melee, close, ranged, out of range) as on-screen text." }), body, sy)
            ...
            end, { description = "Show a draggable preview frame so you can position the distance bracket display, even without a real target." }), body, sy)

            sy = P(GUI:CreateFormCheckbox(body, "Combat Only", "combatOnly", rangeCheckDB, function() Shared.RefreshRangeCheck() end,
                { description = "Only show the distance bracket display while you are in combat." }), body, sy)
            sy = P(GUI:CreateFormCheckbox(body, "Only Show With Hostile Target", "showOnlyWithTarget", rangeCheckDB, function() Shared.RefreshRangeCheck() end,
                { description = "Only show the display when you have a hostile target selected." }), body, sy)
            sy = P(GUI:CreateFormCheckbox(body, "Shorten Text", "shortenText", rangeCheckDB, function() Shared.RefreshRangeCheck() end,
                { description = "Use abbreviated distance labels (e.g., Melee/Close/Far) instead of longer phrasing." }), body, sy)
            ...
            end, { description = "Change the text color to match the current distance bracket (e.g., red when out of range). Overrides Use Class Color." })
            ...
            textColorPicker = GUI:CreateFormColorPicker(body, "Text Color", "textColor", rangeCheckDB, function() Shared.RefreshRangeCheck() end, nil,
            ...
            local fontList = Shared.GetFontList()
            sy = P(GUI:CreateFormDropdown(body, "Font", fontList, "font", rangeCheckDB, function() Shared.RefreshRangeCheck() end,
                { description = "Font used for the distance text." }), body, sy)
            sy = P(GUI:CreateFormSlider(body, "Font Size", 8, 48, 1, "fontSize", rangeCheckDB, function() Shared.RefreshRangeCheck() end, nil,
                { description = "Font size of the distance text." }), body, sy)
            ...
            sy = P(GUI:CreateFormDropdown(body, "Frame Strata", strataOptions, "strata", rangeCheckDB, function() Shared.RefreshRangeCheck() end,
                { description = "Rendering layer for the distance display. Raise this if other frames cover it." }), body, sy)
            sy = P(GUI:CreateFormSlider(body, "X-Offset", -700, 700, 1, "offsetX", rangeCheckDB, function() Shared.RefreshRangeCheck() end, nil,
                { description = "Horizontal pixel offset of the distance text from its anchor." }), body, sy)
            P(GUI:CreateFormSlider(body, "Y-Offset", -700, 700, 1, "offsetY", rangeCheckDB, function() Shared.RefreshRangeCheck() end, nil,
                { description = "Vertical pixel offset of the distance text from its anchor." }), body, sy)
