...
local function CreateUnitFramesPage(parent)
    ...
    local function BuildGeneralTab(tabContent)
        ...
        local general = ufdb.general
        if not general then
            ufdb.general = {}
            general = ufdb.general
        end
    ...
    local function BuildUnitTab(tabContent, unitKey)
        ...
        local function RefreshAuras()
            ...
            ns.Registry:Refresh("unitframes", "auras", unitKey)
        end
...
ns.Registry:RegisterOptions("unitframes", {
    label = "Unit Frames",
    order = 40,
    pageBuilder = CreateUnitFramesPage,
})
