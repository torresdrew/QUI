...
function QUI_Anchoring_Options:BuildAnchoringSection(tabContent, frameKey, options, y)
    ...
    local sliderMin = options.sliderRange and options.sliderRange[1] or -500
    local sliderMax = options.sliderRange and options.sliderRange[2] or 500
    ...
    local function OnChange()
        ...
        -- Bidirectional sync: if layout mode is open, reposition the mover handle
