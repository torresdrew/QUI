...
local function BuildGeneralTab(tabContent)
    ...
    -- Combat Timer settings moved to Edit Mode settings panel.
    ...
    -- Pet Warning settings moved to Edit Mode settings panel.

    -- Focus Cast Alert settings moved to Edit Mode settings panel.
    ...
    -- Battle Res Counter settings moved to Edit Mode settings panel.
