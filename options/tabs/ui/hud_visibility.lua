...
local function BuildHUDVisibilityTab(tabContent)
    ...
    BuildVisibilitySection(
        "CDM Visibility",
        db.cdmVisibility,
        function() ns.Registry:Refresh("cdmVisibility", "cdm") end,
        function() ns.Registry:Refresh("cdmVisibility", "cdmMouseover") end
    )
    ...
    BuildVisibilitySection(
        ...
        function() ns.Registry:Refresh("cdmVisibility", "unitframes") end,
        function() ns.Registry:Refresh("cdmVisibility", "unitframesMouseover") end,
        {
    ...
    BuildVisibilitySection(
        ...
        function() ns.Registry:Refresh("customTrackers", "visibility") end,
        function() ns.Registry:Refresh("customTrackers", "mouseover") end
    )
    ...
    BuildVisibilitySection(
        ...
        function() ns.Registry:Refresh("cdmVisibility", "actionBars") end,
        function() ns.Registry:Refresh("cdmVisibility", "actionBarsMouseover") end
    )
    ...
    BuildVisibilitySection(
        "Chat Frames Visibility",
        db.chatVisibility,
        function() ns.Registry:Refresh("cdmVisibility", "chat") end,
        function() ns.Registry:Refresh("cdmVisibility", "chatMouseover") end
    )
