...
local function CreateHUDLayeringPage(parent)
    ...
    local function RefreshUnitFrames() ns.Registry:Refresh("unitframes") end
    local function RefreshCastbars() ns.Registry:Refresh("castbar") end
    local function RefreshCustomTrackers() ns.Registry:Refresh("customTrackers") end
    local function RefreshSkyriding() ns.Registry:Refresh("skyriding") end
...
ns.Registry:RegisterOptions("hudLayering", {
    label = "Frame Levels",
    order = 75,
    pageBuilder = CreateHUDLayeringPage,
})
