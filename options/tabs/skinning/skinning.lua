...
local function BuildSkinningTab(tabContent)
    ...
    GUI:SetSearchContext({tabIndex = 9, tabName = "Skinning & Autohide", subTabIndex = 2, subTabName = "Skinning"})
    ...
    if db and db.general then
        ...
        -- Ready Check settings moved to Edit Mode settings panel.
        ...
        -- M+ Timer and Forces Bar settings moved to Edit Mode settings panel.
        ...
        -- Objective Tracker settings moved to Edit Mode settings panel.
