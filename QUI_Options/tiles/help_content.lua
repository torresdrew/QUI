...
QUI_HelpContent.GettingStarted = {
    {num = "1.", text = ns.L["Open |cff60A5FA/dui|r to access the options panel and explore available modules."]},
    {num = "2.", text = ns.L["Run |cff60A5FA/dui install|r — the guided setup applies the recommended scale, profile, and base frame layout."]},
    ...
    {num = "6.", text = ns.L["Fine-tune element positions with |cff60A5FA/dui layout|r (Layout Mode) or the |cff60A5FAFrame Positioning|r tab."]},
}
...
QUI_HelpContent.SlashCommands = {
    {command = "/dui",          description = ns.L["Open the QUI options panel"]},
    ...
    {command = "/dui debug",    description = ns.L["Toggle debug mode — enables verbose logging for one session"]},
    {command = "/dui layout",   description = ns.L["Open Layout Mode — drag to reposition all QUI frames"]},
    {command = "/dui editmode", description = ns.L["Alias for /dui layout (backward compatibility)"]},
...
QUI_HelpContent.Diagnostics = {
    { label = ns.L["Setup Wizard"],         command = "/dui install",
    ...
    { label = ns.L["Toggle Debug"],         command = "/dui debug",
    ...
    { label = ns.L["Layout Mode"],          command = "/dui layout",
    ...
    { label = ns.L["Performance Monitor"],  command = "/dui perf",
    ...
    { label = ns.L["Open CDM Composer"],    command = "/dui cdm",
    ...
    { label = ns.L["Migration Status"],     command = "/dui migration status",
    ...
    { label = ns.L["Migration Restore Newest"], command = "/dui migration restore 1",
    ...
    { label = ns.L["Migration Log"],        command = "/dui miglog",
    ...
    { label = ns.L["Migration Log Clear"],  command = "/dui miglog clear",
      tooltip = ns.L["Empty the migration debug log buffer."],
      danger = true,
      run = function() QUI:SlashCommandOpen("miglog clear") end },
    { label = ns.L["Anchor Dump"],          command = "/dui anchordump",
    ...
    { label = ns.L["Tooltip Debug On"],     command = "/dui tooltipdebug on",
      tooltip = ns.L["Begin sampling tooltip processing churn every 1 second. Use Tooltip Debug Report to read samples. To log slow callers, type /dui tooltipdebug slow N in chat (N = millisecond threshold)."],
      run = function() QUI:SlashCommandOpen("tooltipdebug on") end },
    { label = ns.L["Tooltip Debug Report"], command = "/dui tooltipdebug report",
    ...
    { label = ns.L["Tooltip Bypass: QoL"],  command = "/dui tooltipdebug bypass qol",
    ...
    { label = ns.L["Tooltip Bypass: Skin"], command = "/dui tooltipdebug bypass skin",
    ...
    { label = ns.L["Tooltip Bypass: All"],  command = "/dui tooltipdebug bypass all",
    ...
    { label = ns.L["Tooltip Bypass: Off"],  command = "/dui tooltipdebug bypass off",
    ...
    { label = ns.L["White-Backdrop Scan"],  command = "/dui tooltipdbg",
    ...
    { label = ns.L["Diagnose Edit Mode"],   command = "/dui diagnose",
    ...
    { label = ns.L["Diagnose Clear"],       command = "/dui diagnose clear",
      tooltip = ns.L["Empty the Edit Mode diagnostic ring buffer."],
      run = function() QUI:SlashCommandOpen("diagnose clear") end },
    { label = ns.L["Combat Profiler On"],   command = "/dui combatprof on",
...
QUI_HelpContent.Links = {
    ...
    },
    {
        ...
        url = "https://github.com/torresqui/QUI",
