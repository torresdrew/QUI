...
do
    ...
    check("BB stamped to current (56)", profile._schemaVersion == 56, tostring(profile._schemaVersion))
end
...
do
    ...
    check("UF stamped to current (56)", profile._schemaVersion == 56, tostring(profile._schemaVersion))
end
...
do
    ...
    check("GF stamped to current (56)", profile._schemaVersion == 56, tostring(profile._schemaVersion))
end
