...
do
    ...
    check("BB stamped to current (55)", profile._schemaVersion == 55, tostring(profile._schemaVersion))
end
...
do
    ...
    check("UF stamped to current (55)", profile._schemaVersion == 55, tostring(profile._schemaVersion))
end
...
do
    ...
    check("GF stamped to current (55)", profile._schemaVersion == 55, tostring(profile._schemaVersion))
end
