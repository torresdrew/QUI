...
do
    ...
    check("BB stamped to current (54)", profile._schemaVersion == 54, tostring(profile._schemaVersion))
end
...
do
    ...
    check("UF stamped to current (54)", profile._schemaVersion == 54, tostring(profile._schemaVersion))
end
...
do
    ...
    check("GF stamped to current (54)", profile._schemaVersion == 54, tostring(profile._schemaVersion))
end
...
do
    ...
    check("idempotent stays at current (51)", profile._schemaVersion == 54, tostring(profile._schemaVersion))
end
