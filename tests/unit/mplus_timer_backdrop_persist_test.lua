...
assert(windowBackdrop.bgColor[1] == WINDOW_BG[1] and windowBackdrop.bgColor[4] == WINDOW_BG[4],
    "precondition: themed window bg is applied right after skinning")
assert(timerBar.frame.bgColor[1] == BAR_BG[1] and timerBar.frame.bgColor[2] == BAR_BG[2],
    "precondition: themed timer-bar bg is applied right after skinning")
assert(sleekBar.bgColor[1] == BAR_BG[1] and sleekBar.bgColor[2] == BAR_BG[2],
...
assert(windowBackdrop.bgColor[1] == WINDOW_BG[1] and windowBackdrop.bgColor[2] == WINDOW_BG[2]
    and windowBackdrop.bgColor[3] == WINDOW_BG[3] and windowBackdrop.bgColor[4] == WINDOW_BG[4],
    "FIX: M+ timer window bg must survive the key-entry scale refresh, not go white")
assert(timerBar.frame.bgColor[1] == BAR_BG[1] and timerBar.frame.bgColor[2] == BAR_BG[2]
    and timerBar.frame.bgColor[3] == BAR_BG[3],
    "FIX: M+ timer bar bg must survive the key-entry scale refresh, not go white")
assert(sleekBar.bgColor[1] == BAR_BG[1] and sleekBar.bgColor[2] == BAR_BG[2]
    and sleekBar.bgColor[3] == BAR_BG[3],
