...
do
    ...
    check("below-floor (46) stamped to CURRENT (58)", profile._schemaVersion == 58, tostring(profile._schemaVersion))
end
...
do
    ...
    check("at-floor (47) stamped to current (58)", profile._schemaVersion == 58, tostring(profile._schemaVersion))
end
