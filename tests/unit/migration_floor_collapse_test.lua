...
do
    ...
    check("below-floor (46) stamped to CURRENT (57)", profile._schemaVersion == 57, tostring(profile._schemaVersion))
end
...
do
    ...
    check("at-floor (47) stamped to 57", profile._schemaVersion == 57, tostring(profile._schemaVersion))
end
...
do
    ...
    check("alpha stamp 48 re-enters squash, stamps to CURRENT (54)", profile._schemaVersion == 57, tostring(profile._schemaVersion))
end
...
do
    ...
    check("pre-v54 (51) stamped to 57", profile._schemaVersion == 57, tostring(profile._schemaVersion))
end
