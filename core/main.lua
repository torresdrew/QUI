...
local defaults = {
    profile = {
        ...
        quiUnitFrames = {
            ...
            -- Raid frames (raid1-raid40, shared settings, group-based grid layout)
            raid = {
                enabled = false,
                borderSize = 1,
                width = 72,
                ...
                layout = {
                    ...
                    memberGrowDirection = "DOWN",
                    sortByRole = false,
                    visibleGroups = { true, true, true, true, true, true, true, true },
                },
                -- Name text
                showName = true,
                nameTextUseClassColor = false,
                ...
                -- Castbar (off by default for raid — too compact)
                castbar = {
                    enabled = false,
                    showIcon = true,
                    width = 72,
                ...
                -- Auras (compact: fewer icons, smaller)
                auras = {
                    showBuffs = false,
                    showDebuffs = true,
                    iconSize = 14,
