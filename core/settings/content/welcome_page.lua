...
local function BuildWelcomeContent(content)
    ...
    local githubItem = CreateLinkItem(content,
        ns.L["|cffF0F6FCGitHub|r"], "https://github.com/torresqui/QUI",
        0.941, 0.965, 0.988,
        AssetPath .. "github",
